IntercomRails.config do |config|
  # == Intercom app_id
  # 
  config.app_id = ENV["INTERCOM_APP_ID"] || "wmch7w1e"

  # == Intercom secret key 
  # This is required to enable secure mode, you can find it on your Intercom 
  # "security" configuration page.
  # 
  config.api_secret = "dQSY6IrW75EQK4nnDbmQeJQG9A-E9Nqu8MORH5OQ"
  ...
  #
  config.api_key = "75d933b65c1d5324bef174561af251cbedce9467"
